...
urlpatterns = [
    ...
    path('<int:reservation_id>/reject/', views.rejection_form_view, name='rejected-form-view'),
    path('<int:reservation_id>/reject/request', views.rejection_form, name='rejected-form'),
