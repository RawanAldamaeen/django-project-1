...
from .views import (DoctorsListView,ReservationListView, PatientReservationsListView, ReservationCreateView)
from . import views
...
urlpatterns = [
    ...
    path('<int:doctor_id>/new/', ReservationCreateView.as_view(), name='reservation_form_view'),
